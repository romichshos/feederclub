...
const LogInForm = ({isRegisterForm, handleLogInClick}) => {
    let psw, username, emailReg, user, email, imgUrl, isLogOut;
   return  (
        ...
        <div className="fields">
            {(isRegisterForm) ?
                <div className="email">
                    ...
                    <input type='email' className='email-input btn-disable' placeholder='Email'
                           ref={node => (emailReg = node)}/>
                </div>
                :
                <div></div>
            }
            <div className="username">
                ...
                <input type='username' className='user-input btn-disable' placeholder='Имя пользователя'
            ...
            <div className="password">
                ...
                <input type='password' className='pass-input btn-disable' placeholder='Пароль' ref={node => (psw = node)}/>
            </div>
        </div>
